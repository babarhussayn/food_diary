    ...
    <div className="detail-main">
      <div className="detail-content">
        <div className="detail-cont-1">
          ...
          <p>
            <strong>Cuisine:</strong> {product.cuisine}
          </p>
          <p>
            <strong>Difficulty:</strong> {product.difficulty}
          </p>
          <p>
            <strong>Prep Time:</strong> {product.prepTimeMinutes} minutes
          </p>
          <p>
            <strong>Cook Time:</strong> {product.cookTimeMinutes} minutes
          </p>
          <p>
          ...
          <ul>
            {product.ingredients.map((ingredient, i) => (
              <li key={i}>
                <img src="/icons/Group-6.png" alt="icon-green " />
                {ingredient}
              </li>
            ))}
          </ul>
